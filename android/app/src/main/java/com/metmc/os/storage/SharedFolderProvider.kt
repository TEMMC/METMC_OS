...
class SharedFolderProvider : DocumentsProvider() {
    companion object {
        private const val ROOT_ID = "metmc_shared"
    ...
    override fun queryRoots(projection: Array<out String>?): Cursor {
        ...
        return MatrixCursor(columns).apply {
            newRow().apply {
                ...
                add(Root.COLUMN_TITLE, "METMC OS Shared")
    ...
    private fun MatrixCursor.includeFile(file: File, documentId: String) {
        ...
        newRow().apply {
            ...
            add(Document.COLUMN_DISPLAY_NAME, if (documentId == ROOT_DOCUMENT_ID) "METMC OS Shared" else file.name)
